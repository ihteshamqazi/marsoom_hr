...
<div class="main-container container-fluid">
  <div class="text-center">
    <h1 class="page-title">النماذج</h1>
  </div>
  ...
  <div class="row">
    ...
    <li>
        <a class="dropdown-item" href="<?php echo site_url('users2/print_salary_certificate/' . $employee['employee_id']); ?>" target="_blank">
            <i class="fas fa-file-invoice-dollar fa-fw me-2"></i>خطاب إثبات مزايا
        </a>
    </li>
    <li>
        <a class="dropdown-item" href="<?php echo site_url('users2/print_eos_certificate/' . $employee['employee_id']); ?>" target="_blank">
            <i class="fas fa-handshake fa-fw me-2"></i>إفادة نهاية الخدمة
        </a>
    </li>
    
    <li>
        <a class="dropdown-item" 
           href="<?php echo site_url('users2/print_commitment_letter/' . $employee['employee_id']); ?>" 
           target="_blank">
            <i class="fas fa-university fa-fw me-2"></i>نموذج التزام تحويل راتب (مكتب)
        </a>
    </li>
    <li>
        <a class="dropdown-item" 
           href="<?php echo site_url('users2/print_commitment_letter_marsoom/' . $employee['employee_id']); ?>" 
           target="_blank">
            <i class="fas fa-university fa-fw me-2"></i>نموذج التزام تحويل راتب (مرسوم)
        </a>
    </li>

    <li>
        <a class="dropdown-item" 
           href="<?php echo site_url('users2/print_embassy_letter/' . $employee['employee_id']); ?>" 
           target="_blank">
            <i class="fas fa-university fa-fw me-2"></i>    خطاب تعريف سفارة ايطالية انجلش
        </a>
    </li>
    </ul>
