...
<div class="main-container container-fluid">
    <div class="text-center"><h1 class="page-title">Payroll Process</h1></div>
    <div class="card table-card">
        <div class="card-body">
            <table class="table table-striped table-bordered dataTables-example w-100">
                <thead><tr><th>ID</th><th>N1</th><th>N2</th><th>N3</th><th>N4</th><th>N5</th><th>N6</th><th>N7</th><th>Actions</th></tr></thead>
                <tbody></tbody>
            </table>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="genericForm">
                    ...
                    <div class="row">
                        <?php for($i=1; $i<=31; $i++): ?>
                            <div class="col-md-2 mb-3"><label>N<?= $i ?></label><input type="text" name="n<?= $i ?>" class="form-control"></div>
                        <?php endfor; ?>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var dt = $('.dataTables-example').DataTable({
            ...
            ajax: { url: "<?php echo site_url('emp_management/dt_payroll_process'); ?>", type: "POST", data: function(d) { d[csrfName] = csrfHash; } },
