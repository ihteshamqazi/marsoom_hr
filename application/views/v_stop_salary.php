...
<div class="main-container container-fluid">
    <div class="text-center"><h1 class="page-title">Stop Salary</h1></div>
    <div class="card table-card">
        <div class="card-body">
            <table class="table table-striped table-bordered dataTables-example w-100">
                <thead><tr><th>#</th><th>Emp ID</th><th>Sheet ID</th><th>Reason</th><th>Start Date</th><th>End Date</th><th>Actions</th></tr></thead>
                <tbody></tbody>
            </table>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form id="genericForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3"><label>Sheet ID</label><input type="text" name="sheet_id" class="form-control"></div>
                        ...
                        <div class="col-md-6 mb-3"><label>Date</label><input type="date" name="date" class="form-control"></div>
                        <div class="col-md-6 mb-3"><label>Time</label><input type="time" step="1" name="time" class="form-control"></div>
                        <div class="col-md-6 mb-3"><label>Stop Leave Accrual</label><input type="text" name="stop_leave_accrual" class="form-control"></div>
                        <div class="col-md-6 mb-3"><label>Created At</label><input type="datetime-local" step="1" name="created_at" class="form-control"></div>
                        <div class="col-md-12 mb-3"><label>Reason</label><textarea name="reason" class="form-control" rows="2"></textarea></div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        const TABLE_NAME = 'stop_salary';
        
        var dt = $('.dataTables-example').DataTable({
            pageLength: 20, processing: true, serverSide: true, order: [],
            ajax: { url: "<?php echo site_url('emp_management/dt_stop_salary'); ?>", type: "POST", data: function(d) { d[csrfName] = csrfHash; } },
