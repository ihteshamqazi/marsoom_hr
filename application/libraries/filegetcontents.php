...
//دالة تغيير كلمة المرور لحساب الإرسال في موقع موبايلي بإستخدام File_Get_Contents
...
//دالة إسترجاع كلمة المرور لحساب الإرسال في موقع موبايلي بإستخدام File_Get_Contents
...
//دالة عرض الرصيد بإستخدام File_Get_Contents
...
//دالة الإرسال بإستخدام File_Get_Contents
...
//دالة الإرسال بإستخدام قالب رسالة موحد من خلال File_Get_Contents
...
//دالة حذف الرسائل المجدولة بإستخدام File_Get_Contents
...
//دالة طلب إسم مرسل (جوال) بإستخدام File_Get_Contents
...
//دالة تفعيل إسم مرسل (جوال) بإستخدام File_Get_Contents
...
//دالة التحقق من حالة طلب إسم مرسل (جوال) بإستخدام File_Get_Contents
...
//دالة طلب إسم مرسل (أحرف) بإستخدام File_Get_Contents
...
//دالة التحقق من حالة طلب إسم مرسل (أحرف) بإستخدام File_Get_Contents
