...
<head>
    <meta charset="UTF-8">
    <title>Reparations Management</title>
...
<div class="main-container container-fluid">
    <div class="text-center"><h1 class="page-title">Reparations</h1></div>
    <div class="card table-card">
        <div class="card-body">
            <table class="table table-striped table-bordered dataTables-example w-100">
                <thead><tr><th>#</th><th>Type</th><th>Emp ID</th><th>Emp Name</th><th>Amount</th><th>Reparation Date</th><th>Sheet ID</th><th>Actions</th></tr></thead>
                <tbody></tbody>
            </table>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form id="genericForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3"><label>Reparation Date</label><input type="date" name="reparation_date" class="form-control"></div>
                        <div class="col-md-12 mb-3"><label>Notes</label><textarea name="notes" class="form-control" rows="2"></textarea></div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        const TABLE_NAME = 'reparations';
        
        var dt = $('.dataTables-example').DataTable({
            pageLength: 20, processing: true, serverSide: true, order: [],
            ajax: { url: "<?php echo site_url('emp_management/dt_reparations'); ?>", type: "POST", data: function(d) { d[csrfName] = csrfHash; } },
