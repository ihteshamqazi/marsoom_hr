                ...
                <div class="col-md-6 col-lg-4" id="sheet-card-<?php echo $sheet['id']; ?>">
                    <div class="card sheet-card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    <a href="<?php echo site_url('users1/attendance_view/'.$sheet['id']); ?>" class="btn btn-attendance action-btn">
                                        <i class="fas fa-fingerprint"></i> الحضور
                                    </a>
                                </div>
                                <div class="col-6">
                                    <a href="<?php echo site_url('users1/payroll_view101/'.$sheet['id']); ?>" class="btn btn-payroll action-btn">
