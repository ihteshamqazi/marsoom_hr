...
<div class="main-container container-fluid">
    <div class="text-center"><h1 class="page-title">Attendance Summary</h1></div>
    <div class="card table-card">
        <div class="card-body">
            <table class="table table-striped table-bordered dataTables-example w-100">
                <thead><tr><th>#</th><th>Emp ID</th><th>Name</th><th>Absence</th><th>Mins Late</th><th>Mins Early</th><th>ID Sheet</th><th>Actions</th></tr></thead>
                <tbody></tbody>
            </table>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="genericForm">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3"><label>Emp ID</label><input type="text" name="emp_id" class="form-control"></div>
                        <div class="col-md-6 mb-3"><label>Emp Name</label><input type="text" name="emp_name" class="form-control"></div>
                        <div class="col-md-4 mb-3"><label>Absence</label><input type="number" step="any" name="absence" class="form-control"></div>
                        <div class="col-md-4 mb-3"><label>Minutes Late</label><input type="number" step="any" name="minutes_late" class="form-control"></div>
                        <div class="col-md-4 mb-3"><label>Minutes Early</label><input type="number" step="any" name="minutes_early" class="form-control"></div>
                        <div class="col-md-6 mb-3"><label>Single Thing</label><input type="text" name="single_thing" class="form-control"></div>
                        <div class="col-md-6 mb-3"><label>ID Sheet</label><input type="text" name="id_sheet" class="form-control"></div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        const TABLE_NAME = 'attendance_summary';
        
        var dt = $('.dataTables-example').DataTable({
            pageLength: 20, processing: true, serverSide: true, order: [],
            ajax: { url: "<?php echo site_url('emp_management/dt_attendance_summary'); ?>", type: "POST", data: function(d) { d[csrfName] = csrfHash; } },
