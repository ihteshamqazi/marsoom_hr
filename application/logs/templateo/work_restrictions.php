                  ...
                  <tr>
                    <td>
                      <button type="button" class="btn btn-sm btn-primary"
                              onclick="openExemptionPopup('<?php echo $get_salary_vacations['emp_id']; ?>', '<?php echo $this->uri->segment(3,0); ?>')">
                        <?php echo $get_salary_vacations['emp_id']; ?>
                      </button>
                    </td>
                    <td><?php echo $get_salary_vacations['emp_name']; ?></td>
                    <td><?php echo $get_salary_vacations['management']; ?></td>
                    <td><?php echo $get_salary_vacations['company']; ?></td>
                    <td><?php echo $get_salary_vacations['first_punch']; ?></td>
                    <td><?php echo $get_salary_vacations['last_punch']; ?></td>
                    <td><?php echo $get_salary_vacations['maximum_departure_date']; ?></td>
    ...
    layout: {
      topStart: {
        buttons: [
          ...
          {
            text:'<i class="fa fa-file-export"></i> تصدير بيانات  قيود العمل',
