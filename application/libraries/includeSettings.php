...
//$this->load->view('function/checkSendPorts'); 
$this->load->library('checkSendPorts');
echo "string";
exit;
if(fsockopenTest() == 5)
{
	//إختبار دالة fsockopen
	//include("function/fsockopen.php");
	$this->load->view('function/fsockopen'); 
}
elseif(curlTest() == 5)
{
	//إختبار دالة curl
	//include("function/curl.php");
	$this->load->view('function/curl');
}
elseif(fopenTest() == 3)
{
	//إختبار دالة fopen
	//include("function/fopen.php");
	$this->load->view('function/fopen');
}
elseif(fileTest() == 3)
{
	//إختبار دالة curl
	//include("function/file.php");
	$this->load->view('function/file');
}
elseif(filegetcontentsTest() == 3)
{
	//إختبار دالة fopen
	//include("function/filegetcontents.php");
	$this->load->view('function/filegetcontents');
}
else
{
	//للخروج من عملية الإرسال في حال لم يكن هنالك أي دالة مفعله
	echo "لا يوجد لديك دوال مفعلة<br>راجع الإستضافة وفعل إحدى البوابات الثلاث fsockopen و curlSMS و fopenSMS";
}

//لطباعة القيمة الناتجه من بوابة الإرسال على شكل نص
//include("function/functionPrintResult.php");
$this->load->view('function/functionPrintResult');
