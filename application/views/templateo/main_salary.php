...
<body>
    ...
    <div class="top-fixed-nav">
        ...
        <button class="btn btn-primary" onclick="window.location.href='#'">
            ...
            <img width="145" height="35" src="<?php echo base_url();?>/assets/imeges/m2.PNG" alt="Marsom Logo">
    ...
    <div class="main-screen-container position-relative">
        ...
        <div class="quick-actions-grid">
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
               <div class="col">
  <a href="<?php echo site_url('users1/work_restrictions'); ?>" class="quick-action-button">
    <i class="fas fa-business-time"></i> <!-- Icon مناسب لقيود العمل -->
    <span>قيود العمل</span>
  </a>
</div>

               <a href="<?php echo site_url('users1/salary_sheets_list'); ?>" class="quick-action-button">
    <i class="fas fa-clock"></i>
    <span>الحضور والانصراف</span>
</a>

                <div class="col">
                    <a href="<?php echo site_url('users1/payroll_summary'); ?>" class="quick-action-button">
                        <i class="fas fa-money-check-alt"></i>
                        <span>ملخص الرواتب</span>
                    </a>
                </div>
                <div class="col">
    <a href="<?php echo site_url('users1/exemption_management'); ?>" class="quick-action-button">
        ...
        <span>إدارة الإعفاءات</span>
                ...
                <div class="col">
                 ...
                 <div class="col">
    <a href="<?php //echo site_url('users1/discounts101'); ?>" class="quick-action-button">
        <i class="fas fa-building"></i> <!-- 🏢 للتأمينات الاجتماعية -->
...
<div class="col">
    <a href="<?php //echo site_url('users1/discounts101'); ?>" class="quick-action-button">
        <i class="fas fa-balance-scale"></i> <!-- ⚖️ للمقارنات -->
...
<div class="col">
    <a href="<?php //echo site_url('users1/discounts101'); ?>" class="quick-action-button">
        ...
        <i class="fas fa-user-slash"></i> <!-- ❌ للمستبعدين -->
        <span>الموظفين المستجدين والمستبعدين</span>
    </a>
</div>

<div class="col">
    <a href="<?php //echo site_url('users1/discounts101'); ?>" class="quick-action-button">
        <i class="fas fa-ban"></i> <!-- ⛔ لإيقاف الرواتب -->
        <span>إيقاف الرواتب</span>
    </a>
</div>
