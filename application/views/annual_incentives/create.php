...
<head>
  ...
  <title><?= html_escape($title ?? 'إنشاء دفعة حوافز سنوية') ?></title>
...
<body>
  ...
  <div class="wrap">
    ...
    <div class="header-nav">
      <div class="title-box">
        <h1>إنشاء دفعة حوافز سنوية</h1>
        <p>حدد اسم الحافز والسنة والميزانية وطريقة احتساب الراتب</p>
      </div>
    ...
    <?php if($this->session->flashdata('err')): ?>
      <div class="alert alert-danger mb-3"><?= $this->session->flashdata('err') ?></div>
    <?php endif; ?>

    <!-- Form -->
    <div class="glass-card">
      <form method="post" action="<?= site_url('AnnualIncentives/store_setup') ?>">
        <div class="row">
          <div class="col-md-5">
            <div class="form-group">
              <label><i class="fas fa-tag"></i> اسم الحافز</label>
              <input type="text" name="batch_name" class="form-control" placeholder="مثال: حافز سنوي 2026" required>
            </div>
          </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <input type="text" name="batch_year" class="form-control" placeholder="2026" required>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" name="budget_total" class="form-control" placeholder="1,000,000" required>
              <small class="muted d-block mt-2">يدعم الفواصل: 1,000,000</small>
            </div>
          </div>
        </div>
        ...
        <div class="mb-2 font-weight-bold" style="color:#fff;">
          <i class="fas fa-sliders"></i> طريقة احتساب الراتب (قاعدة الحافز)
        </div>

        <div class="custom-control custom-radio mb-2">
          <input type="radio" id="mode_total" name="calc_mode" class="custom-control-input" value="total" checked>
          <label class="custom-control-label" for="mode_total">
            احتساب <span class="pill"><i class="fas fa-sack-dollar"></i> إجمالي الراتب (total_salary)</span> — وإلغاء باقي الخيارات
          </label>
        </div>

        <div class="custom-control custom-radio mb-3">
          <input type="radio" id="mode_parts" name="calc_mode" class="custom-control-input" value="parts">
          <label class="custom-control-label" for="mode_parts">
            احتساب حسب أجزاء الراتب (تختار أنت)
          </label>
        </div>
        ...
        <div id="partsBox" class="p-3" style="display:none;">
          <div class="row">
            <div class="col-md-3 mb-2">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" id="use_base_salary" name="use_base_salary" class="custom-control-input">
            ...
            <div class="col-md-3 mb-2">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" id="use_housing_allowance" name="use_housing_allowance" class="custom-control-input">
            ...
            <div class="col-md-3 mb-2">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" id="use_transport_allowance" name="use_transport_allowance" class="custom-control-input">
                <label class="custom-control-label" for="use_transport_allowance">بدل المواصلات (n4)</label>
              </div>
            </div>

            <div class="col-md-3 mb-2">
              <div class="custom-control custom-checkbox">
                <input type="checkbox" id="use_other_allowances" name="use_other_allowances" class="custom-control-input">
          ...
          <small class="muted d-block mt-2">
            لو لم تحدد أي خيار، ستكون قاعدة الحساب = 0، وبالتالي الحوافز = 0.
          </small>
        </div>

        <div class="d-flex justify-content-end mt-4">
          <button class="btn-marsom primary" type="submit" style="padding:12px 18px;">
            <i class="fas fa-arrow-left"></i> التالي: اختيار الموظفين
          </button>
        </div>
      </form>
    </div>
