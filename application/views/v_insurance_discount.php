...
<head>
    <meta charset="UTF-8">
    <title>Insurance Discount</title>
...
<div class="main-container container-fluid">
    <div class="text-center"><h1 class="page-title">Insurance Discount</h1></div>
    <div class="card table-card">
        <div class="card-body">
            <table class="table table-striped table-bordered dataTables-example w-100">
                <thead><tr><th>#</th><th>N1</th><th>N2</th><th>N3</th><th>Actions</th></tr></thead>
                <tbody></tbody>
            </table>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="genericForm">
                    ...
                    <div class="mb-3"><label>N1</label><input type="text" name="n1" class="form-control"></div>
                    <div class="mb-3"><label>N2</label><input type="text" name="n2" class="form-control"></div>
                    <div class="mb-3"><label>N3</label><input type="text" name="n3" class="form-control"></div>
                </form>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        const TABLE_NAME = 'insurance_discount';
        
        var dt = $('.dataTables-example').DataTable({
            pageLength: 20, processing: true, serverSide: true, order: [],
            ajax: { url: "<?php echo site_url('emp_management/dt_insurance_discount'); ?>", type: "POST", data: function(d) { d[csrfName] = csrfHash; } },
