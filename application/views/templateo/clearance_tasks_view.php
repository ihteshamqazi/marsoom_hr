                            ...
                            <?php else: ?>
                                <?php foreach ($tasks as $task): ?>
                                    <tr>
                                        ...
                                        <td><?php echo html_escape($task['resigning_employee_id']); ?></td>
                                        <td><?php echo html_escape($task['resigning_employee_name']); ?></td>
                                        <td><?php echo html_escape($task['resigning_employee_manager']); ?></td>
                                        ...
                                        <td>
    <button class="btn btn-sm btn-success dept-action-btn" data-task-id="<?php echo $task['task_id']; ?>" data-action="approved">نعم</button>
    <button class="btn btn-sm btn-danger dept-action-btn" data-task-id="<?php echo $task['task_id']; ?>" data-action="rejected">لا</button>
</td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
