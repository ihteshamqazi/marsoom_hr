...
<body>
    ...
    <div class="container-fluid">
        <h5 class="page-header" style="font-size:30px;">  الاجازات   وطلبات الموظفين     </h5>
   ...
   <div class="order-4">
    <button class="btn custom-colvis-btn" onclick="openVacationForm()">
        ...
        <span style="color: white; font-weight: bold;">إضافة إجازة</span>
    </button>
</div>
                ...
                <tbody>
                    ...
                    <?php $idno=0; ?>
                             ...
                             <tr  style="font-family: 'Tajawal', sans-serif; font-weight: bold; font-style: normal; font-size:12px;">
                                       ...
                                       <td ><?php     echo $get_salary_vacations['start_date']; ?></td> 
                                       <td ><?php     echo $get_salary_vacations['end_date']; ?></td> 
                                        <td ><?php     echo $get_salary_vacations['status']; ?></td> 
                                       <td ><?php      echo $get_salary_vacations['date']; ?></td>
                                          <td ><?php      echo $get_salary_vacations['time']; ?></td>
                                        <td ><?php   
                                       echo $get_salary_vacations['type']; ?></td> 
