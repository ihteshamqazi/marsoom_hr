...
<div class="main-container container-fluid">
    ...
    <div class="card table-card">
        ...
        <div class="btn-group">
            <a href="<?php echo site_url('users1/export_balances_excel_all'); ?>" class="btn btn-success">
                <i class="fa fa-file-excel me-2"></i> تصدير كل البيانات (Excel)
            </a>
            <a href="<?php echo site_url('users1/export_balances_pdf_all'); ?>" class="btn btn-danger" style="background-color: #dc3545; border-color: #dc3545;">
                <i class="fa fa-file-pdf me-2"></i> تصدير كل البيانات (PDF)
            </a>
        </div>
    </div>
...
$(document).ready(function() {
    $('#balances-table').DataTable({
        ...
        "pageLength": 25,
        "ajax": {
            "url": "<?php echo site_url('users1/fetch_all_balances'); ?>",
            "type": "POST"
        },
        "columns": [
            { "data": "employee_id" },
            ...
            { "data": "balance_allotted" },
            { "data": "balance_consumed" },
