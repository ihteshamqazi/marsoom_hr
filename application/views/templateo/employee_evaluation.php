...
<div class="main-container container-fluid">
  <div class="text-center">
    <h1 class="page-title">  التقييم </h1>
  </div>
       ...
       <th>       </th>
                               ...
                               <th>   المشرف المباشر   </th> 
                                ...
                                <th>          الإجمالي</th>
                                 ...
                                 <th> الإجمالي + المعيار الاستثنائي </th> 
                                            <th> اسم المقيم  </th>
                                                 <th>تاريخ التقييم</th> 
                                                    <th>وقت التقييم </th>
                                                         <th>  w20 </th> 
                                                          <th> المهام الوظيفية</th>
                                                          <th> المهارات القيادية</th>
                                                           <th>المهارات الإدارية + او المهارات التقنية</th>
                                                              <th>الخطط الاستراتيجية </th>
                </tr>
              </thead>
              <tbody>
    <?php foreach($customers as $customers) : ?>
        ...
        <tr>
           ...
           <td ><?php    echo $idno; ?></td> 
             ...
             <td > <a title=" <?php echo $customers['w1']; ?>    " class="btn btn-blue btn-xs" href="<?php echo site_url('users/view_orders2023/'.$customers['w1']); ?>" target="_blank">
                   <?php echo $customers['w2']; ?>  
              </a> </td> 
                                       ...
                                       <td ><?php      echo $customers['w1']; ?></td> 
                                       <td ><?php      echo $customers['w2']; ?></td> 
                                       <td ><?php      echo $customers['w3']; ?></td> 
                                       <td ><?php      echo $customers['w4']; ?></td> 
                                       <td ><?php      echo $customers['w5']; ?></td> 
                                       <td ><?php      echo $customers['w6']; ?></td> 
                                       <td ><?php      echo $customers['w7']; ?></td> 
                                       <td ><?php      echo $customers['w8']; ?></td> 
                                       <td ><?php      echo $customers['w9']; ?></td> 
                                       <td ><?php      echo $customers['w10']; ?></td> 
                                       <td ><?php      echo $customers['w11']; ?></td> 
                                       <td ><?php      echo $customers['w12']; ?></td> 
                                       <td ><?php      echo $customers['w13']; ?></td> 
                                       <td ><?php      echo $customers['w14']; ?></td> 
                                       <td ><?php      echo $customers['w15']; ?></td> 
                                       <td ><?php      echo $customers['w16']; ?></td> 
                                       <td ><?php      echo $customers['w17']; ?></td> 
                                       <td ><?php      echo $customers['w18']; ?></td> 
                                       <td ><?php      echo $customers['w19']; ?></td> 
                                       <td ><?php      echo $customers['w20']; ?></td> 
                                       <td ><?php      echo $customers['w21']; ?></td> 
                                       <td ><?php      echo $customers['w22']; ?></td> 
                                       <td ><?php      echo $customers['w23']; ?></td>
                                       <td ><?php      echo $customers['w23']; ?></td> 
        </tr>
    <?php endforeach; ?>
</tbody>
