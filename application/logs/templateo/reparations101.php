...
<div class="main-container container-fluid">
  <div class="text-center">
    <h1 class="page-title">     التعويضات </h1>
  </div>
...
<script>
  ...
  window.open(url,'AddReparation','width='+width+',height='+height+',top='+top+',left='+left+',resizable=yes,scrollbars=yes,status=no');
}
    ...
    layout: {
      topStart: {
        buttons: [
          ...
          {
            text:'<i class="fa fa-file-export"></i> تصدير بيانات     التعويضات',
            className:'btn btn-outline-light',
            action:function(){ openExportPopup(); }
          },
  {
    text:'<i class="fa fa-plus-circle"></i> إضافة تعويض جديد',
