                            ...
                            <tbody>
                                <?php foreach ($employees as $row): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong><?php echo number_format($total_absence_deduction + $total_single_punch_deduction + $total_late_exit_deduction, 2); ?></strong></td>
                                        <td><strong><?php echo number_format($total_absence_deduction + $discount_amount + $total_single_punch_deduction + $total_late_exit_deduction, 2); ?></strong></td>
                                        ...
                                        <td>
                                            <strong>
                                                <?php 
                                                $final_salary555 = $final_salary - $final_salary111;
