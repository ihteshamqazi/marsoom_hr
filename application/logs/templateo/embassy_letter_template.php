...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .fillable, .edit-view { border-bottom: 1px solid transparent; background-color: transparent; }
            .edit-view { display: none !important; } .text-view { display: inline !important; }
            strong, b, .data-label, .closing-block p { font-weight: 700 !important; }
        }
    </style>
</head>
<body>
    ...
    <div id="letterContainer" class="letter-container">
        ...
        <div class="bilingual-row">
            <div class="col-ar"><p><input type="text" class="fillable" style="width: 150px;" placeholder="أدخل التاريخ الهجري"></p></div>
