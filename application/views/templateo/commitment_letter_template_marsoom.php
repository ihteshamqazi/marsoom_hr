...
<head>
    ...
    <style>
        ...
        .letter-container {
            width: 21cm;
            min-height: 29.7cm; /* A4 Height for screen simulation */
            padding: 2.5cm;
        ...
        /* FIXED: Removed 'margin-top: auto' to fix the large gap */
        .closing-block { 
            font-weight: 700; 
            margin-top: 4rem; /* Fixed distance from text */
            padding-top: 1rem; 
        }
