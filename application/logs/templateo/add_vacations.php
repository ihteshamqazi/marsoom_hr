...
<head>
    ...
    <title>إدخال بيانات الإجازة</title>
...
<body>
    ...
    <div class="container-fluid">
        <h1 class="page-header">إدخال بيانات الإجازة</h1>
<?php echo validation_errors(); ?>
             <?php echo form_open_multipart('users/add_vacations'); ?>
        <form id="leaveForm">
             <div class="mb-3">
        <label for="employeeId">الرقم الوظيفي <i class="fas fa-id-badge text-primary"></i></label>
        <input type="text" name="username" class="form-control" id="employeeId" placeholder="أدخل الرقم الوظيفي" required>
    </div>
    <div class="mb-3">
        <label for="employeeName">اسم الموظف <i class="fas fa-user-tie text-success"></i></label>
        <input type="text" name="name" class="form-control" id="employeeName" placeholder="أدخل اسم الموظف" readonly>
    </div>

   

            <div class="mb-3">
                <label for="startDate">تاريخ البدء <i class="fas fa-calendar-alt text-info"></i></label>
                <input type="text" class="form-control datepicker" name="start_date" id="startDate" placeholder="YYYY/MM/DD" required>
            </div>
            <div class="mb-3">
                <label for="endDate">تاريخ الانتهاء <i class="fas fa-calendar-alt text-warning"></i></label>
                <input type="text" class="form-control datepicker" name="end_date" id="endDate" placeholder="YYYY/MM/DD" required>
            </div>
            <div class="mb-4">
                ...
                <select name="type" class="form-select" id="requestType" required>
                    <option selected disabled value="">اختر نوع الإجازة...</option>
                    <option value="اجازة سنوية">إجازة سنوية</option>
                    <option value="اجازة مرضية">إجازة مرضية</option>
                    <option value="اجازة اضطرارية">إجازة اضطرارية</option>
                    <option value="اجازة بدون راتب">إجازة بدون راتب</option>
                    <option value="اجازة حج">إجازة حج</option>
                    <option value="اجازة زواج">إجازة زواج</option>
                    <option value="تصحيح بصمة">طلب تصحيح بصمة</option>.
                    <option value="مهمة عمل عن بعد">مهمة عمل عن بعد</option>
                </select>
            </div>
