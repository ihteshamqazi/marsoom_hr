...
<div class="main-container container-fluid">
    <div class="text-center"><h1 class="page-title">Discounts</h1></div>
    <div class="card table-card">
        <div class="card-body">
            <table class="table table-striped table-bordered dataTables-example w-100">
                <thead><tr><th>#</th><th>Type</th><th>Emp ID</th><th>Emp Name</th><th>Amount</th><th>Discount Date</th><th>Sheet ID</th><th>Actions</th></tr></thead>
                <tbody></tbody>
            </table>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form id="genericForm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3"><label>Username</label><input type="text" name="username" class="form-control"></div>
                        <div class="col-md-4 mb-3"><label>Name</label><input type="text" name="name" class="form-control"></div>
                        ...
                        <div class="col-md-6 mb-3"><label>Discount Date</label><input type="date" name="discount_date" class="form-control"></div>
                        <div class="col-md-6 mb-3"><label>Is Recurring</label><input type="text" name="is_recurring" class="form-control"></div>
                        <div class="col-md-12 mb-3"><label>Notes</label><textarea name="notes" class="form-control"></textarea></div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var dt = $('.dataTables-example').DataTable({
            ...
            ajax: { url: "<?php echo site_url('emp_management/dt_discounts'); ?>", type: "POST", data: function(d) { d[csrfName] = csrfHash; } },
