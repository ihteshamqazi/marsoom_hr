...
<div class="container my-5">
    <div class="card shadow-sm">
        <div class="card-header bg-success text-white">
            <h3 class="mb-0">رفع بيانات الموظفين من ملف CSV</h3>
        </div>
        <div class="card-body">
            ...
            <div class="alert alert-info">
                ...
                <ul class="mb-0">
                    ...
                    <li>يجب أن تكون البيانات مفصولة بفواصل (comma-separated).</li>
            ...
            <form action="<?= site_url('users1/process_employee_upload_csv') ?>" method="post" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="employee_file" class="form-label">اختر ملف CSV</label>
                    <input class="form-control" type="file" name="employee_file" id="employee_file" required accept=".csv">
