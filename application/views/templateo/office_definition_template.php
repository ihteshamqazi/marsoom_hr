...
<head>
    <meta charset="UTF-8">
    <title>خطاب تعريف - مكتب المحاماة</title>
    ...
    <style>
        ...
        /* Salary Table Styles */
        .salary-table { width: 100%; border-collapse: collapse; margin-top: 10px; font-size: 14px; text-align: center; }
        .salary-table th { border: 1px solid #000; padding: 10px 5px; background-color: #fff; font-weight: 700; }
        .salary-table td { border: 1px solid #000; padding: 10px 5px; font-weight: 500; direction: ltr; } 

        /* Fixed Footer Style */
        .footer { 
            margin-top: 4rem; /* Standard gap for screen */
            font-weight: 700; 
            font-size: 16px; 
            text-align: center; 
        }
    ...
    .letter-container::before {
        content: "";
        display: block;
        height: 15mm; /* Adjust this value based on your company letterhead size */
        width: 100%;
        margin-bottom: 1rem;
    }
...
<body>
    ...
    <div class="letter-container">
        ...
        // Ensure $order_id is available in the view (passed from controller)
        ...
        if (class_exists('IntlDateFormatter')) {
            try {
                $formatterG = new IntlDateFormatter(
                    'ar_SA', 
        ...
        <div class="letter-body">
            ...
            <br>
            يشهد مكتب / صالح بن منصور الجربوع محامون ومستشارون بأن المذكور ادناه يعمل لدينا ومازال على رأس العمل وقد أعطي هذا الخطاب بناء على طلبه دون أدنى مسؤولية على المكتب .
        </div>
        ...
        <div class="info-grid">
            ...
            <div class="value"><?php echo number_format($employee->total_salary, 0); ?> ريال</div>
        </div>
        ...
        <div class="footer">
            مكتب / صالح بن منصور الجربوع محامون ومستشارون
        </div>
    </div>

    <script>
        // Optional: Adjust letterhead space based on actual letterhead size
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Test function to adjust letterhead space
            function adjustForPrinting() {
                // If you know your letterhead height in mm, calculate rem:
                // 1rem ≈ 16px ≈ 4.23mm (at 96 DPI)
                // Example: 80mm letterhead = 80/4.23 ≈ 18.9rem
                
                // Uncomment and adjust if needed:
                // const letterheadHeightMM = 80; // Your actual letterhead height in mm
                // const letterheadHeightREM = letterheadHeightMM / 4.23;
                // 
                // // Update the print style dynamically
                // const style = document.createElement('style');
                // style.innerHTML = `@media print { .letter-container { padding-top: ${letterheadHeightREM}rem !important; } }`;
