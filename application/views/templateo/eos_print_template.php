...
<body>
    ...
    إشارة إلى انتهاء العلاقة التعاقدية بيني أنا الموظف الموضح بياناته في الجدول أعلاه وشركة مرسوم (سداد سابقاً)؛ أقر وأعلن بأن إجمالي جميع مستحقاتي المالية والعينية والتي تشمل كافة حقوقي التعاقدية والنظامية مثل (الرواتب الشهرية، قيمة الاجازات، مكافأة نهاية الخدمة، وغيرها) عن كامل مدة عملي مع الشركة بقيمة (<span id="arabic-amount"><?php echo $final_amount; ?></span>) فقط <span id="arabic-words"></span> لا غير. وبالتوقيع على هذا الاقرار أبرئ ذمة الشركة، وعملائها والعاملين فيها إبراء شاملاً ومطلقاً لا رجعة فيه من أي حق أو مطالبة أو ادعاء من أي نوع كان حالياً ومستقبلاً، وأقر بأنني وقعت على هذا الاقرار وأنا بكامل الاهلية المعتبرة شرعاً ونظاماً وبمحض إرادتي واختياري دون ضغط أو إكراه أو إلجاء من أحد.
    <br><br>
    <center>والله ولي التوفيق.</center>
        ...
        <div class="footer">
            th Floor   Zip code 12244, add No.: 2567 – Bld No: 6847, Office No.: 736 Riyadh – Main Olay St, 2nd Real Estate –
        </div>
    ...
    <script>
        ...
        // Function to convert numbers to Arabic words (fixed version)
        function convertToArabicWords(number) {
            ...
            // Add currency only once at the end
            result += ' ريال';
        ...
        // Get the final amount and convert it
